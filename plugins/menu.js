  ...
  try {
      ...
      const sections = [
   {
	...
	rows: [
	    ...
	    {title: `🌟 BUY PREMIUM`, rowId: ".sewa", description: "Menampilkan list harga premium"},
	]
	},{
	title: `⃟⟣⟚⟝ ⟡ List Menu ${namabot} ⟡ ⟞⟚⟢⃟`,
	rows: [
	...
	{title: `🏂 MAKER`, rowId: ".? maker", description: "Random Maker"},
