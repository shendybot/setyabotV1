...
let teksbio = `👋 Hai ${tag} Ada yang bisa *Setya Bot* bantu? 
Ketik *.menu2* untuk melihat fitur bot ini
`
conn.sendButtonDoc(m.chat, teksbio, wm,'MENU','.menu2', ftroli, { gifPlayback: true, contextInfo: { externalAdReply: {title: namabot, body: date, sourceUrl: linkyt, thumbnail: fs.readFileSync('./thumbnail.jpg') }}})
}
handler.command = /^(mgyghhg)$/i
