...
if (msgg) return conn.sendButtondDoc(m.chat, `${global.htki} VERIFY ${global.htka}`, msgg, '𝚅𝚎𝚛𝚒𝚏𝚢', '.verify', m, { contextInfo: { externalAdReply: { showAdAttribution: true,
...
global.thumb = 'https://telegra.ph/file/9a05fef824e941506c474.jpg'
